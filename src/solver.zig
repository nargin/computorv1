...
fn getPolynomialDegree(coefficients: [11]f64) usize {
    var degree: usize = 0;
...
fn printReducedForm(coefficients: [11]f64) void {
...
pub fn quadratic_solver(coefficients: [11]f64) !void {
    ...
    printReducedForm(coefficients);

    const degree = getPolynomialDegree(coefficients);
